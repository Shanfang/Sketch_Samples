...
dom_size specifies the domain of the possible values tuples can take.
tuples_no is the number of tuples the relation contains, while tuples contains the actual values.
*/
